...
# ⚠️ ตั้งใจฝังเลขไว้ ไม่ได้นับจาก shops.yaml — ถ้านับจากไฟล์เดียวกันที่ตรวจ
#    ด่านนี้จะเห็นด้วยกับทุกการแก้เสมอ รวมทั้งการแก้ที่ไม่ได้ตั้งใจ
#    19 ร้านในไฟล์ ปิดไว้ 1 (lazada_03 ยังติดสิทธิ์)
#    2026-08-18: 16 → 18 — เปิด lazada_02 กลับมา (ได้สิทธิ์แล้ว) + เพิ่ม tiktok_06 Metool
EXPECTED_SHOPS = 18
