...
**ร้านที่มีจริงตอนนี้: 16 ร้าน** — Lazada 1 + TikTok 5 + Shopee 10
ดึงได้จริงแล้ว **11 ร้าน** อีก 5 ร้านติดฝั่งแพลตฟอร์ม (ดูหัวข้อถัดไป)
...
ทั้ง 5 ร้านตั้ง `enabled: false` + `skip_reason` ไว้ → ขึ้น ⚪ SKIPPED ไม่ใช่ 🔴 FAILED
...
| `shopee_07` Yonghouse Official Store | เข้าหน้าคำสั่งซื้อไม่ได้ — "ร้านค้านี้ไม่สามารถเข้าถึงหน้านี้ได้" | ผู้ใช้เปิดดูเอง 2026-08-04 |
| `shopee_09` Yong House ยงเฮ้าส์ | เหมือนกัน (บัญชี `YM_SP:Osuka` เดียวกัน) | ↑ |
| `shopee_10` บ้านช่าง Baanchang | เหมือนกัน | ↑ |
